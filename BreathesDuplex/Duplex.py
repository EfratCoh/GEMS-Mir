...
from BreathesDuplex.duplex_utils import mix_inter_bulge_seq
...
# class Duplex(ABC):
class Duplex():
    def __init__(self, mrna_bulge: str, mrna_inter: str, mir_inter: str, mir_bulge:str, MFE=None) -> None:
    ...
    def fromChimera(cls, mirna: str, target: str) -> Duplex:
        duplex_dict_cls_return = {}
        duplex_dict_interactions = cls.createDuplex(mirna, target)

        for key, value in duplex_dict_interactions.items():

            try:
                mrna_bulge, mrna_inter, mir_inter, mir_bulge, MFE = value
            ...
            new_duplex = {key :cls(mrna_bulge, mrna_inter, mir_inter, mir_bulge, MFE)}
            duplex_dict_cls_return.update(new_duplex)
        return duplex_dict_cls_return
    ...
    def canonical_seed(self):
        ...
        # append that the number of bulge equal to 0
        return ((c2_7 == 6) and seed_2_7.mrna_bulge_count == 0) or (c3_8 == 6 and seed_3_8.mrna_bulge_count == 0)
